/**
*  @file calcRelPosVelFreeSlip.cuh
...
/**
 *	@brief Calculates the relative position and velocity between two particles (free-sleep condition on wall)
 ...
 */
__device__ static void calcRelPosVelFreeSlip(
